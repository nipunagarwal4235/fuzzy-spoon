...
function Navbar() {
  ...
  <div class="absolute right-200 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    <div class="py-1" role="none">
      ...
      <form method="POST" action="#" role="none">
        <button type="submit" class="text-gray-700 block w-full px-4 py-2 text-left text-sm" role="menuitem" tabindex="-1" id="menu-item-3">Sign out</button>
            ...
            <a class="mr-5 hover:text-gray-900 cursor-pointer">Newsroom</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer">Gallery</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer">Blog</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer">Contact Us</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer">Other</a>
          </nav>
        </div>
      </header>
    </div>
